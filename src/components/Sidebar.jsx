...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    ...
    >
      {/* <!-- SIDEBAR HEADER --> */}
      <div className='flex items-center justify-between gap-2 px-10 py-1.5 lg:py-1.5'>
        <NavLink to='/'>
          <div className='w-17'>
            <img
              className='object-contain  bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none'
              src={Logo}
              alt='SIDC PASSER'
            />
          </div>
      ...
      <div className='no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear'>
        ...
        <nav className='mt-5 py-4 px-4 lg:mt-9 lg:px-6'>
          {/* <!-- Menu Group --> */}
          <div>
            <h3 className='mb-4 ml-4 text-sm font-semibold logo.pngdark2'>
              MENU
            </h3>
